...
namespace BojkoSoft.Transformations.Tests
{
    ...
    public class TestBGSWithTPS
    {
        ...
        public void TransformFromBGS1930()
        {
            ...
            IPoint result = tr.Transform(input, enumProjection.BGS_1930_24, enumProjection.BGS_2005_KK);
            Common.CheckResults(expected, result, Common.DELTA_BGS);
            
            // 27 degrees
            input = new TestPoint(4729531.133, 9361175.733);
            //result = tr.TransformBGSCoordinates(input, enumProjection.BGS_1930_27, enumProjection.BGS_2005_KK);
            result = tr.Transform(input, enumProjection.BGS_1930_27, enumProjection.BGS_2005_KK);
            Common.CheckResults(expected, result, Common.DELTA_BGS);
        }
        ...
        public void TransformToBGS1930()
        {
            ...
            IPoint result = tr.Transform(input, enumProjection.BGS_2005_KK, enumProjection.BGS_1930_24);
            Common.CheckResults(expected, result, Common.DELTA_BGS);

            // 27 degrees
            expected = new TestPoint(4729531.133, 9361175.733);
            //result = tr.TransformBGSCoordinates(input, enumProjection.BGS_2005_KK, enumProjection.BGS_1930_27);
            result = tr.Transform(input, enumProjection.BGS_2005_KK, enumProjection.BGS_1930_27);
            Common.CheckResults(expected, result, Common.DELTA_BGS);
        }
        ...
        public void TransformFromBGS1950()
        {
            ...
            IPoint result = tr.Transform(input, enumProjection.BGS_1950_3_24, enumProjection.BGS_2005_KK);
            Common.CheckResults(expected, result, Common.DELTA_BGS);

            // 3 deg 27 degrees
            input = new TestPoint(4729899.053, 9361082.960);
            //result = tr.TransformBGSCoordinates(input, enumProjection.BGS_1950_3_27, enumProjection.BGS_2005_KK);
            result = tr.Transform(input, enumProjection.BGS_1950_3_27, enumProjection.BGS_2005_KK);
            Common.CheckResults(expected, result, Common.DELTA_BGS);

            // 6 deg 21 degrees
            input = new TestPoint(4737501.141, 4852808.182);
            //result = tr.TransformBGSCoordinates(input, enumProjection.BGS_1950_6_21, enumProjection.BGS_2005_KK);
            result = tr.Transform(input, enumProjection.BGS_1950_6_21, enumProjection.BGS_2005_KK);
            Common.CheckResults(expected, result, Common.DELTA_BGS);

            // 6 deg 27 degrees
            input = new TestPoint(4729899.053, 5361082.960);
            //result = tr.TransformBGSCoordinates(input, enumProjection.BGS_1950_6_27, enumProjection.BGS_2005_KK);
            result = tr.Transform(input, enumProjection.BGS_1950_6_27, enumProjection.BGS_2005_KK);
            Common.CheckResults(expected, result, Common.DELTA_BGS);
        }
        ...
        public void TransformToBGS1950()
        {
            ...
            IPoint result = tr.Transform(input, enumProjection.BGS_2005_KK, enumProjection.BGS_1950_3_24);
            Common.CheckResults(expected, result, Common.DELTA_BGS);

            // 3 deg 27 degrees
            expected = new TestPoint(4729899.053, 9361082.960);
            //result = tr.TransformBGSCoordinates(input, enumProjection.BGS_2005_KK, enumProjection.BGS_1950_3_27);
            ...
            //result = tr.TransformBGSCoordinates(input, enumProjection.BGS_2005_KK, enumProjection.BGS_1950_6_21);
            result = tr.Transform(input, enumProjection.BGS_2005_KK, enumProjection.BGS_1950_6_21);
            Common.CheckResults(expected, result, Common.DELTA_BGS);

            // 6 deg 27 degrees
            expected = new TestPoint(4729899.053, 5361082.960);
            //result = tr.TransformBGSCoordinates(input, enumProjection.BGS_2005_KK, enumProjection.BGS_1950_6_27);
            result = tr.Transform(input, enumProjection.BGS_2005_KK, enumProjection.BGS_1950_6_27);
            Common.CheckResults(expected, result, Common.DELTA_BGS);
        }
        ...
        public void TransformFromBGSSofia()
        {
            ...
            IPoint result = tr.Transform(input, enumProjection.BGS_SOFIA, enumProjection.BGS_2005_KK);
            Common.CheckResults(expected, result, Common.DELTA_BGS);
        }
        ...
        public void TransformToBGSSofia()
        {
            ...
            IPoint result = tr.Transform(input, enumProjection.BGS_2005_KK, enumProjection.BGS_SOFIA);
            Common.CheckResults(expected, result, Common.DELTA_BGS);
        }
        ...
        public void TransformFromBGS1970()
        {
            ...
            IPoint result = tr.Transform(input, enumProjection.BGS_1970_K3, enumProjection.BGS_2005_KK);
            Common.CheckResults(expected, result, Common.DELTA_BGS);
            ...
            result = tr.Transform(input, enumProjection.BGS_1970_K5, enumProjection.BGS_2005_KK);
            Common.CheckResults(expected, result, Common.DELTA_BGS);
            ...
            result = tr.Transform(input, enumProjection.BGS_1970_K7, enumProjection.BGS_2005_KK);
            Common.CheckResults(expected, result, Common.DELTA_BGS);
            ...
            result = tr.Transform(input, enumProjection.BGS_1970_K9, enumProjection.BGS_2005_KK);
            Common.CheckResults(expected, result, Common.DELTA_BGS);
        }
        ...
        public void TransformToBGS1970()
        {
            ...
            IPoint result = tr.Transform(input, enumProjection.BGS_2005_KK, enumProjection.BGS_1970_K3);
            Common.CheckResults(expected, result, Common.DELTA_BGS);
            ...
            result = tr.Transform(input, enumProjection.BGS_2005_KK, enumProjection.BGS_1970_K5);
            Common.CheckResults(expected, result, Common.DELTA_BGS);
            ...
            result = tr.Transform(input, enumProjection.BGS_2005_KK, enumProjection.BGS_1970_K7);
            Common.CheckResults(expected, result, Common.DELTA_BGS);
            ...
            result = tr.Transform(input, enumProjection.BGS_2005_KK, enumProjection.BGS_1970_K9);
            Common.CheckResults(expected, result, Common.DELTA_BGS);
        }
        ...
        public void PointCloseToBorder()
        {
            ...
            IPoint result = tr.Transform(input, enumProjection.BGS_2005_KK, enumProjection.BGS_1970_K9);
            Common.CheckResults(expected, result, Common.DELTA_BGS);
        }
